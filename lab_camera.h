...
namespace implemented
{
    ...
    public:
        ...
        void setForward(const glm::vec3 inForward)
        {
			forward = inForward;
		}

        void setRight(const glm::vec3 inRight)
		{
            right = inRight;
        }
    ...
    public:
        ...
        glm::vec3 position;
        glm::vec3 beforeRotationForward;
        glm::vec3 beforeRotationUp;
        glm::vec3 beforeRotationRight;
        glm::vec3 forward;
        glm::vec3 right;
        glm::vec3 up;
    };
